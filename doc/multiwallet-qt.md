...
In order to support loading of multiple wallets in smc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smc.cpp.
...
Changes to smc.cpp
----------------------
smc.cpp is the entry point into smc-qt, and as such, will require some minor modifications to provide hooks for
