...
This mechanism has been integrated into Bitcore-Node-SMC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kobrin/insight-api-smc#web-socket-api](https://github.com/kobrin/insight-api-smc#web-socket-api) 
* API: [https://github.com/kobrin/insight-api-smc#swifttx-transactions](https://github.com/kobrin/insight-api-smc#swifttx-transactions) 
...
By default, the SMC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SMC Core daemon:
