...
RESOURCES += src/qt/smc.qrc src/qt/smc_locale.qrc

TRANSLATIONS += src/qt/locale/smc_bg.ts \
                src/qt/locale/smc_de.ts \
                src/qt/locale/smc_en.ts \
                src/qt/locale/smc_es.ts \
                src/qt/locale/smc_fi.ts \
                src/qt/locale/smc_fr.ts \
                src/qt/locale/smc_it.ts \
                src/qt/locale/smc_ja.ts \
                src/qt/locale/smc_pl.ts \
                src/qt/locale/smc_pt.ts \
                src/qt/locale/smc_ru.ts \
                src/qt/locale/smc_sk.ts \
                src/qt/locale/smc_sv.ts \
                src/qt/locale/smc_vi.ts \
                src/qt/locale/smc_zh_CN.ts \
                src/qt/locale/smc_zh_TW.ts
