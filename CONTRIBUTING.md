Contributing to SMC Core
============================

The SMC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SMC Core project, and is not to be
confused with overall SMC Network Protocol consensus changes.

Whether a pull request is merged into SMC Core rests with the project merge
...
Patches that change SMC consensus rules are considerably more involved than
...
Where a patch set proposes to change the SMC consensus, it must have been
...
The project leader is the release manager for each SMC Core release.
