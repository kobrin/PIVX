...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total smc balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zSMCsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zSMC denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zSMC denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zSMC denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zSMC denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zSMC denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zSMC denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zSMC denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zSMC denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zSMC denominations\n"
            "  }\n"
    ...
    obj.push_back(Pair("zSMCsupply", zpivObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"smcaddress\"\n"
            "\nReturn information about the given smc address.\n"

            "\nArguments:\n"
            "1. \"smcaddress\"     (string, required) The smc address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"smcaddress\", (string) The smc address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: SMC address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are smc addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) smc address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"smcaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"smcaddress\"  (string, required) The smc address to use for the signature.\n"
