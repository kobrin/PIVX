...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "smc.seed.fuzzbawls.pw"));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "smc.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "smc-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "smc-testnet.seed2.fuzzbawls.pw"));
