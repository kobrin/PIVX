...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SMC features */
        {"smc", "masternode", &masternode, true, true, false},
        {"smc", "listmasternodes", &listmasternodes, true, true, false},
        {"smc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"smc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"smc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"smc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"smc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"smc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"smc", "masternodedebug", &masternodedebug, true, true, false},
        {"smc", "startmasternode", &startmasternode, true, true, false},
        {"smc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"smc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"smc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"smc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"smc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"smc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"smc", "mnbudget", &mnbudget, true, true, false},
        {"smc", "preparebudget", &preparebudget, true, true, false},
        {"smc", "submitbudget", &submitbudget, true, true, false},
        {"smc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"smc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"smc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"smc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"smc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"smc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"smc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"smc", "checkbudgets", &checkbudgets, true, true, false},
        {"smc", "mnsync", &mnsync, true, true, false},
        {"smc", "spork", &spork, true, true, false},
        {"smc", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> smc-cli " + methodname + " " + args + "\n";
}
