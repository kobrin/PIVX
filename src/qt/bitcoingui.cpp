                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SMC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SMC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSMC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SMC Core"), this);
    aboutAction->setStatusTip(tr("Show information about SMC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SMC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SMC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SMC addresses"));
    ...
    openAction->setStatusTip(tr("Open a SMC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SMC Core help message to get a list with possible SMC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SMC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SMC network", "", count));
}
...
{
    QString strTitle = tr("SMC Core"); // default title
