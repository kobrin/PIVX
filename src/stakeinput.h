...
#ifndef SMC_STAKEINPUT_H
#define SMC_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZSMC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zSMCStake can take two forms
...
public:
    ...
    bool IsZSMC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZSMC() override { return false; }
};


#endif //SMC_STAKEINPUT_H
