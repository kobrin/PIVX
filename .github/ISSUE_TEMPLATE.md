...
This issue tracker is only for technical issues related to SMC Core.
General SMC questions and/or support requests and are best directed to the [SMC Discord](https://discord.smc.org).
...
### What version of SMC Core are you using?
